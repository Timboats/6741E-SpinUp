...
Drivetrain::Drivetrain(float wheelDiameter, float gearRatio, unsigned int frontRightMotorPort, unsigned int backRightMotorPort, unsigned int frontLeftMotorPort, unsigned int backLeftMotorPort, unsigned int northWheelAngle, unsigned int southWheelAngle, unsigned int eastWheelAngle, unsigned int westWheelAngle, unsigned int inertialPort, DualGps* gpsSystem){
    ...
    this -> frontRightMotorPort = frontRightMotorPort;
    this -> backRightMotorPort = backRightMotorPort;
    this -> frontLeftMotorPort = frontLeftMotorPort;
    this -> backLeftMotorPort = backLeftMotorPort;
